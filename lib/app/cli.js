...
cli.initGuide = function(argv, env) {
    var options = [
        '   Usage: fekey init <templateFrom> [descPath]',
        '',
        '   Command:',
        '     <templateFrom>   local path or template from github',
        '     [descPath]       set deliver to local path',
        '',
        '   Example:',
        '     fekey init node newsystem',
        '     fekey init ./fekey-scaffold-template',
        '     fekey init h5',
        ''
    ];
